...
export function useWallets() {
  return useQuery({
    ...
    queryFn: async () => {
      const res = await apiClient.api.wallet.$get();
...
export function useWallet(id: string) {
  return useQuery({
    ...
    queryFn: async () => {
      const res = await apiClient.api.wallet[":id"].$get({ param: { id } });
...
export function useDefaultWallet() {
  return useQuery({
    ...
    queryFn: async () => {
      const res = await apiClient.api.wallet.default.$get();
...
export function useCreateWallet() {
  ...
  return useMutation({
    mutationFn: async (data: {
      ...
      const res = await apiClient.api.wallet.$post({ json: data });
      if (!res.ok) {
...
export function useUpdateWallet() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const res = await apiClient.api.wallet[":id"].$put({
        param: { id },
        json: data,
      });
...
export function useDeleteWallet() {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      const res = await apiClient.api.wallet[":id"].$delete({ param: { id } });
