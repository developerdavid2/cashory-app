    ...
    >
      ...
      >
        <View style={{ width: contentWidth, flex: 1 }}>
          ...
          <View className="mt-7.5 gap-2.5" style={{ width: 327 }}>
            <Text
          ...
          <View className="mt-5.5">
            ...
            >
              ...
              <View
                className="absolute -bottom-1 right-[35%] w-9.5 h-9.5 rounded-full items-center justify-center"
                style={{
                  backgroundColor: colors.inputBackground,
                  borderWidth: 3,
          ...
          <View className="mt-5.5 gap-2.5" style={{ width: contentWidth }}>
            <Input
              ...
              className="h-17.5 rounded-[15px] px-5 text-body-sm leading-3.75 bg-muted/10"
              style={{
                fontFamily: ONBOARDING_FONT_FAMILY.regular,
                color: colors.textPrimary,
              }}
          ...
          <View className="mt-auto gap-5.75" style={{ width: ctaWidth }}>
            <ControlField
            ...
            <AuthPrimaryButton
              ...
              disabled={!agreedToTerms || !name || !email || isSubmitting}
