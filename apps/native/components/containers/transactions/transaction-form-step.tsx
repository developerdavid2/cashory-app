    ...
    <View className="flex-col gap-y-4 mt-5.5 px-3.75">
      ...
      <View className="flex-row gap-x-4">
        ...
        <View className="flex-1 flex-col gap-y-2.5">
          ...
          >
            <Select.Trigger
              variant="unstyled"
              className="flex-row items-center justify-between rounded-2xl bg-brand-flashwhite dark:bg-dark-charcoal-green px-4 min-h-12"
            >
              <Select.Value
      ...
      <View className="flex-col gap-y-2.5">
        ...
        <TextArea
          ...
          className="rounded-2xl bg-brand-flashwhite dark:bg-dark-charcoal-green px-4 pt-4 pb-8 min-h-30 text-body-sm leading-3.75 text-brand-black dark:text-brand-white border-0 shadow-none focus:border-0"
          style={{
